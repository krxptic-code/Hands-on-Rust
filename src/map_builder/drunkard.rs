...
pub struct DrunkardsWalksArchitect {}

impl MapArchitect for DrunkardsWalksArchitect {
    fn new(&mut self, rng: &mut RandomNumberGenerator) -> MapBuilder {
        ...
        mb.monster_spawns = mb.spawns_monsters(&center, rng);
