...
fn main() -> BError {
    let context = BTermBuilder::new()
        ...
        .with_simple_console_no_bg(
            DISPLAY_WIDTH, DISPLAY_HEIGHT, "dungeonfont.png")
        .with_simple_console_no_bg(
            SCREEN_WIDTH * 2, DISPLAY_HEIGHT * 2, "terminal8x8.png")
        .build()?;
    ...
    fn tick(&mut self, ctx: &mut BTerm) {
        ...
        match current_state {
            ...
            TurnState::MonsterTurn => {
                self.monster_system.execute(&mut self.ecs, &mut self.resources)
            },
...
impl State {
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "You put on the Amulet of Java and feel its power course through your veins."
        );
        ctx.print_color_centered(7, GREEN, BLACK, "Press F to play again.");
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "The Amulet of Java remains unclaimed, and your home town is not saved."
        );
        ctx.print_color_centered(
            8,
            YELLOW,
        ...
        ctx.print_color_centered(9, GREEN, BLACK, "Press F to play again.");
    ...
    fn advance_level(&mut self) {
        ...
        cb.flush(&mut self.ecs, &mut Resources::default());
        ...
        if map_level == 2 {
            spawn_amulet_of_java(&mut self.ecs, map_builder.amulet_start);
        } else {
            let exit_idx = map_builder.map.point2d_to_index(map_builder.amulet_start);
            map_builder.map.tiles[exit_idx] = TileType::Exit;
        }
